...
int main(int argc, char** argv) {
    ...
    world.add(make_shared<sphere>(vec3(0, -1001, 0), 1000, ground_mat));
    ...
    world.add(make_shared<sphere>(vec3(2, 0, -2), 1, matte_mat));
    
    shared_ptr<reflective> reflect_mat = make_shared<reflective>(vec3(0.3, 0.3, 0.3));
    world.add(make_shared<sphere>(vec3(0, 0, -3), 1, reflect_mat));
    ...
    world.add(make_shared<sphere>(vec3(-1, 0, -2), 1, di_mat));
    world.add(make_shared<sphere>(vec3(-1, 0, -2), .9, bubble_mat));
